    ...
    protected function renderFileList(): string {
        ...
        foreach ($this->files($this->idTestRecord) as $file) {
            ...
            $items[] = '<tr data-file-id="' . $file->id . '">'
                    ...
                    . '<td class="text-right">'
                    . '<a href="' . $secureUrl . '" target="_blank" class="btn btn-sm btn-outline-primary mr-1">'
                    . '<i class="fas fa-download"></i>'
                    . '</a>'
                    . '<button class="btn btn-sm btn-outline-danger" onclick="deleteAttachedFile(' . $file->id . ', \'' . $this->id . '\')">'
